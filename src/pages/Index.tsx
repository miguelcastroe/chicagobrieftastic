  ...
  },
  {
    ...
    icon: (
      <div className="mt-5 relative w-16 h-16">
        <div className="absolute bottom-0 left-[30%] -translate-x-1/2 w-0 h-0 border-l-[25px] border-r-[25px] border-b-[43.3px] border-text-white rounded-[16px] transform rotate-45 animate-rocket" style={{ clipPath: 'polygon(50% 15%, 0% 100%, 100% 100%)' }} />
      </div>
    ),
  },
];
